...
```{r}
combined_df<-read_data("/usr4/bf527/dlenci/Documents/project-3-saxophone-1/counts_data")
...
write.csv(combined_df, 
          "/usr4/bf527/dlenci/Documents/project-3-saxophone-1/r_script_out/combined_counts.csv")
...
```{r}
count_df <- read_data("/usr4/bf527/dlenci/Documents/project-3-saxophone-1/r_script_out/combined_counts.csv")
...
write.csv(AhR_vs_cont,
          "/projectnb2/bf528/users/saxophone/DESeq_results/AhR_vs_ctrl.csv")
write.csv(CAR_vs_cont,
          "/projectnb2/bf528/users/saxophone/DESeq_results/CAR_PXR_vs_ctrl.csv")
write.csv(DNA_vs_cont,
          "/projectnb2/bf528/users/saxophone/DESeq_results/DAN_Dmg_vs_ctrl.csv")
```
...
ggsave("DE_hist.png", plot = scatter_plot, width = 8, height = 5,
       path = "/usr4/bf527/dlenci/Documents/project-3-saxophone-1/r_script_out" )
ggsave("DE_scat.png", plot = hist_plot, width = 8, height = 5,
       path = "/usr4/bf527/dlenci/Documents/project-3-saxophone-1/r_script_out" )
